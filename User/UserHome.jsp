...
%>
<html>
<script type="text/javascript" src="js/UserBookingCheck.js">
...
<body>
	...
	<button onclick="display()" id="btn">profile</button>
	<button id="logoutButton">
		<a href="logout_user.jsp" id="button">Logout</a>
	</button>
	<section class="banner" id="top">
		<div class="container">
			<div class="row">
				...
				<form method="post" action="TicketReservation.jsp" id="myForm">
					<%
					if (session1.getAttribute("errormsgt") != null) {
					%>
					<h1 style="color: orange;"><%=session1.getAttribute("errormsgt")%></h1>
					<%
					session1.setAttribute("errormsgt", "");
					}
					%>
							...
							<div id="tab1">
								<div class="submit-form">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<fieldset>
												<label for="to">To:</label> <select name='to'
													onchange='this.form.()' id="to">
													<option value="">Select a location...</option>
													<%
													DaoService ds1 = new DaoService();

													try {
														Statement statement = ds1.getMyStatement();
														String query = "SELECT city FROM Cities";
														ResultSet resultSet = statement.executeQuery(query);
														while (resultSet.next()) {
															String city = resultSet.getString(1);
										...
										<div class="col-md-6">
											<fieldset>
												<label for="departure">Departure date:</label> <input
													name="departure" type="text" class="form-control date"
													id="deparure" placeholder="Select date..."
													onchange='this.form.()'>
											</fieldset>
										</div>
										<div class="col-md-6">
											<fieldset>
												<label for="return">Return date:</label> <input
													name="return" type="text" class="form-control date"
													id="return" placeholder="Select date..."
													onchange='this.form.()'>
											</fieldset>
										</div>
										<div class="col-md-6">
											<label for="selectTrip">Select Trip Type:</label> <select
												name="selectTrip" id="selectTrip"
												onchange='this.form.trip.value=this.value;'>
												<option value="round">Round</option>
												<option value="one-way">Oneway</option>
											</select>
										</div>
										<label for="seat">Seat Number:</label> <input type="text"
											id="seat" name="seat"><br>
										<br>
										<div class="col-6">
											<div class="d-flex flex-column">
												<label class="text mb-1">Enter your airlines:</label><br>
												<input class="form-control mb-3 pt-2" type="text"
													name="airline" placeholder="enter your airines:">
											</div>
										</div>
										<label for="travelClass">Class of Travel:</label> <select
											id="travelClass" name="travelClass" required>
										...
										<div class="col-md-6">
											<fieldset>
												<button type="submit" id="form-submit" class="btn"
													onclick="return validateForm();">Order Ticket Now</button>
											</fieldset>
										</div>
									</div>
				</form>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="service-item first-service">
						...
						<h4>Easy Tooplate</h4>
						<p>Donec varius porttitor iaculis. Integer sollicitudin erat
							et ligula viverra vulputate. In in quam efficitur, pulvinar justo
							ut, tempor nunc. Phasellus pharetra quis odio.</p>
						</a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="service-item second-service">
						<div class="service-icon"></div>
						<h4>Unique Ideas</h4>
						<p>Cras ligula diam, tristique at aliquam at, fermentum auctor
							turpis. Proin leo massa, iaculis elementum massa et, consectetur
							varius dolor. Fusce sed ipsum sit.</p>
						</a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="service-item third-service">
						<div class="service-icon"></div>
						<h4>Best Support</h4>
						<p>Fusce leo dui. Mauris et justo eget arcu ultricies porta.
							Nulla facilisi. Nulla nec risus sit amet magna hendrerit
							venenatis. Sed porta tincidunt lectus eget ultrices.</p>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="wrapper">
					<div class="col-md-4">
						<ul class="tabs clearfix" data-tabgroup="third-tab-group">
							<li><a href="#livingroom" class="active">Living Room <i
									class="fa fa-angle-right"></i></a></li>
							<li><a href="#suitroom">Suit Room <i
									class="fa fa-angle-right"></i></a></li>
							<li><a href="#swimingpool">Swiming Pool <i
									class="fa fa-angle-right"></i></a></li>
							<li><a href="#massage">Massage Service <i
									class="fa fa-angle-right"></i></a></li>
							<li><a href="#fitness">Fitness Life <i
									class="fa fa-angle-right"></i></a></li>
							<li><a href="#event">Evening Event <i
									class="fa fa-angle-right"></i></a></li>
						</ul>
					</div>
				</div>
						...
						<div id="livingroom">
							<div class="text-content">
								<iframe width="100%" height="400px"
									src="https://www.youtube.com/embed/rMxTreSFMgE"> </iframe>
							</div>
						</div>
						<div id="suitroom">
							<div class="row">
	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<p>
						Copyright &copy; 2018 Flight Tour and Travel Company | Design: <a
							href="http://www.tooplate.com/view/2093-flight" target="_parent"><em>Flight</em></a>
					</p>
				</div>
			</div>
		</div>
