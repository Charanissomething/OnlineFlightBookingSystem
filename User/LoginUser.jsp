	...
	<section>
		...
		<div class="signin">
			<%
				...
				if (session1.getAttribute("errormsg") != null) {
			%>
			<p style="color: lime;"><%=session1.getAttribute("errormsg")%></p>
			<%
				session1.setAttribute("errormsg", "");
			}
			%>
			<div class="content">
				<h2>Sign In</h2>
				<div class="form">
					<form action="User/logincheck.jsp" method="post">
						<div class="inputBox">
							<input type="text" name="userid" autocomplete="off"> <i>Userid</i>
						</div>
						<br>
						<br>
						<div class="inputBox">
